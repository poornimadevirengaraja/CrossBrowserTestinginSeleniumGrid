...
public class EdgeOptions extends baseclass {
	WebDriver driver;
	...
	public void testonchrome() {
		...
		System.out.println(driver.getTitle()+" from MicrosoftEdge");
		System.out.println(driver.getCurrentUrl()+" from MicrosoftEdge");
	}
